...
local function registerDynamicTraits()
	...
	registerTraits({
		...
		ETW_Registry.traits.DEPRESSIVE,
		...
		ETW_Registry.traits.PROWESS_BLADE,
		ETW_Registry.traits.PROWESS_BLUNT,
		ETW_Registry.traits.PROWESS_GUNS,
		ETW_Registry.traits.PROWESS_SPEAR,
