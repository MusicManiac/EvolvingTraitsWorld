...
function ETWMoodles.bloodlustMoodleUpdate(player, hide)
	if SBvars.BloodlustMoodle == true then
		...
		if player == getPlayer() and modOptions:getOption(EnableBloodLustMoodle) == true and hide == false and timeSinceLastKill <= SBvars.BloodlustMoodleVisibilityHours then
