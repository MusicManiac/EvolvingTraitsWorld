...
local function asthmaticTraitETW()
	...
	if (running or sprinting) and (temperature <= 10 or smoker) then
		...
		if detailedDebug() then print("ETW Logger | asthmaticTraitETW(): counterDecrease: ".. counterDecrease ..", modData.AsthmaticCounter: " .. modData.AsthmaticCounter) end
	end
	if not running and not sprinting and temperature >= 0 then
		...
		if detailedDebug() then print("ETW Logger | asthmaticTraitETW(): counterDecrease: " .. counterIncrease .. ", modData.AsthmaticCounter: " .. modData.AsthmaticCounter) end
	end
...
local function painToleranceTraitETW()
	...
	if detailedDebug() then print("ETW Logger | painToleranceTraitETW(): pain counter: " .. modData.PainToleranceCounter) end
